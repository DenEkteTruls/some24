...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1dyne8q");
    			add_location(h1, file$5, 41, 8, 2943);
    			attr_dev(p0, "id", "subtext");
    			attr_dev(p0, "class", "svelte-1dyne8q");
    			add_location(p0, file$5, 42, 8, 2988);
    			if (!src_url_equal(img.src, img_src_value = /*article*/ ctx[0].image_src)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1dyne8q");
    			add_location(img, file$5, 44, 12, 3068);
    			attr_dev(p1, "id", "subimg");
    			attr_dev(p1, "class", "svelte-1dyne8q");
    			add_location(p1, file$5, 46, 16, 3162);
    			attr_dev(div0, "class", "subimgdiv svelte-1dyne8q");
    			add_location(div0, file$5, 45, 12, 3121);
    			attr_dev(div1, "class", "image svelte-1dyne8q");
    			add_location(div1, file$5, 43, 8, 3035);
    			attr_dev(div2, "class", "top svelte-1dyne8q");
    			add_location(div2, file$5, 40, 4, 2916);
    			attr_dev(div3, "class", "bottom svelte-1dyne8q");
    			attr_dev(div3, "id", "article");
    			add_location(div3, file$5, 50, 4, 3248);
    			attr_dev(div4, "class", "container svelte-1dyne8q");
    			add_location(div4, file$5, 39, 0, 2887);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*article*/ ctx[0].image_src)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1vo6svt");
    			add_location(img, file$3, 17, 8, 323);
    			attr_dev(div0, "class", "image-container svelte-1vo6svt");
    			add_location(div0, file$3, 16, 4, 284);
    			attr_dev(h1, "id", "title");
    			attr_dev(h1, "class", "svelte-1vo6svt");
    			add_location(h1, file$3, 29, 8, 848);
    			attr_dev(p, "id", "undertitle");
    			attr_dev(p, "class", "svelte-1vo6svt");
    			add_location(p, file$3, 30, 8, 893);
    			attr_dev(div1, "class", "info-container svelte-1vo6svt");
    			add_location(div1, file$3, 19, 4, 378);
    			attr_dev(div2, "class", "container svelte-1vo6svt");
    			add_location(div2, file$3, 15, 0, 236);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:4) {#each articles as article}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 14, 0, 2191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(body, file$1, 7, 0, 170);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ArticleList, toggle });
    	return [];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-1rhs8lg");
    			add_location(img, file, 8, 8, 163);
    			attr_dev(h1, "class", "svelte-1rhs8lg");
    			add_location(h1, file, 9, 8, 201);
    			attr_dev(div0, "class", "logo-container svelte-1rhs8lg");
    			add_location(div0, file, 7, 4, 106);
    			attr_dev(div1, "class", "mid-part svelte-1rhs8lg");
    			add_location(div1, file, 11, 4, 234);
    			attr_dev(div2, "class", "right-controls svelte-1rhs8lg");
    			add_location(div2, file, 12, 4, 268);
    			attr_dev(div3, "class", "menu svelte-1rhs8lg");
    			add_location(div3, file, 6, 0, 82);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ router: page, Article: Article$1, Home, Menu, page: page$1 });
