...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 43, 8, 3036);
    			attr_dev(p0, "id", "subtext");
    			attr_dev(p0, "class", "svelte-bdlpto");
    			add_location(p0, file$5, 44, 8, 3081);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-s4fk3c");
    			add_location(img, file$3, 17, 12, 364);
    			attr_dev(div0, "class", "image-container svelte-s4fk3c");
    			add_location(div0, file$3, 16, 8, 321);
    			attr_dev(h1, "id", "title");
    			attr_dev(h1, "class", "svelte-s4fk3c");
    			add_location(h1, file$3, 29, 12, 937);
    			attr_dev(p, "id", "undertitle");
    			attr_dev(p, "class", "svelte-s4fk3c");
    			add_location(p, file$3, 30, 12, 986);
    			attr_dev(div1, "class", "info-container svelte-s4fk3c");
    			add_location(div1, file$3, 19, 8, 427);
    			attr_dev(div2, "class", "container svelte-s4fk3c");
    			add_location(div2, file$3, 15, 4, 269);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(15:0) {#if article.size == \\\"small\\\"}",
    		ctx
    	});
    ...
    // (40:16) {#if article.emne == "sikkerhet"}
    function create_if_block_6(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(40:16) {#if article.emne == \\\"sikkerhet\\\"}",
    		ctx
    	});
    ...
    // (21:12) {#if article.emne == "sikkerhet"}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(21:12) {#if article.emne == \\\"sikkerhet\\\"}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:4) {#each articles as article}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 13, 0, 2247);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
