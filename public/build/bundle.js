...
var app = (function () {
    ...
    const file$4 = "src\\pages\\Article.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div6 = element("div");
    			h11 = element("h1");
    			h11.textContent = `${/*article*/ ctx[0].title}`;
    			t6 = space();
    			p0 = element("p");
    			...
    			t11 = space();
    			div7 = element("div");
    			div7.textContent = `${/*article*/ ctx[0].content}`;
    			if (!src_url_equal(img0.src, img0_src_value = "logo.PNG")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			attr_dev(img0, "class", "svelte-1fwg9iq");
    			add_location(img0, file$4, 16, 8, 1677);
    			attr_dev(h10, "class", "svelte-1fwg9iq");
    			add_location(h10, file$4, 17, 8, 1715);
    			attr_dev(div0, "class", "logo-container svelte-1fwg9iq");
    			add_location(div0, file$4, 15, 4, 1620);
    			attr_dev(div1, "class", "mid-part svelte-1fwg9iq");
    			add_location(div1, file$4, 19, 4, 1748);
    			attr_dev(div2, "class", "right-controls svelte-1fwg9iq");
    			add_location(div2, file$4, 20, 4, 1782);
    			attr_dev(div3, "class", "menu svelte-1fwg9iq");
    			add_location(div3, file$4, 14, 0, 1596);
    			attr_dev(h11, "id", "title");
    			attr_dev(h11, "class", "svelte-1fwg9iq");
    			add_location(h11, file$4, 24, 8, 1882);
    			attr_dev(p0, "id", "subtext");
    			attr_dev(p0, "class", "svelte-1fwg9iq");
    			add_location(p0, file$4, 25, 8, 1927);
    			if (!src_url_equal(img1.src, img1_src_value = /*article*/ ctx[0].image_src)) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			attr_dev(img1, "class", "svelte-1fwg9iq");
    			add_location(img1, file$4, 27, 12, 2007);
    			attr_dev(p1, "id", "subimg");
    			attr_dev(p1, "class", "svelte-1fwg9iq");
    			add_location(p1, file$4, 29, 16, 2101);
    			attr_dev(div4, "class", "subimgdiv svelte-1fwg9iq");
    			add_location(div4, file$4, 28, 12, 2060);
    			attr_dev(div5, "class", "image svelte-1fwg9iq");
    			add_location(div5, file$4, 26, 8, 1974);
    			attr_dev(div6, "class", "top svelte-1fwg9iq");
    			add_location(div6, file$4, 23, 4, 1855);
    			attr_dev(div7, "class", "bottom svelte-1fwg9iq");
    			add_location(div7, file$4, 33, 4, 2187);
    			attr_dev(div8, "class", "container svelte-1fwg9iq");
    			add_location(div8, file$4, 22, 0, 1826);
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let articles = [
    		{
    			...
    			content: "Biden - Styrk cyberforsvaret i Ukraina.<br><h2>I løpet av et tiår har sosiale medier forandret måten vi kommuniserer med hverandre på.</h2><br>Vi går i retning av et mer teknologibasert samfunn, og Norge blir ofte omtalt som ett av de mest digitale samfunnene i verden. Ungdom bruker opp mot sju timer i gjennomsnitt på nettet daglig. Ungdom bruker mindre tid sammen med venner ansikt til ansikt, og mer tid på Internett og sosiale medier. Varig lagring: Kommunikasjonen i s"
    		},
    		{
    			id: 1,
    			title: "Ove (32) liker seg i hengekøya: - Blir ofte lange lunsjer",
    			subtext: "Dette er en undertittel til artikkelen, advarers.",
    			alt: "Litt informasjon om bilde som vi ser ovenfor denne tekten i dag har jeg penger i lomma ja",
    			emne: "ferie",
    			image_src: "https://www.kode24.no/images/75644945.jpg?imageId=75644945&panox=0&panoy=36.363636363636&panow=100&panoh=63.636363636364&heighty=0&heightx=44.53781512605&heightw=33.893557422969&heighth=100&width=245&height=205&compression=80",
    	...
    	$$self.$capture_state = () => ({ articles, article, clicked });
    ...
    const file$3 = "src\\components\\Emne.svelte";
    ...
    class Emne extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { text: 0, color: 1 });
    ...
    const file$2 = "src\\components\\Article.svelte";
    ...
    // (21:8) {#if article.emne == "sikkerhet"}
    function create_if_block(ctx) {
    	let emne;
    	let current;

    	emne = new Emne({
    			props: { text: "Sikkerhet", color: "--green" },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(21:8) {#if article.emne == \\\"sikkerhet\\\"}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*article*/ ctx[0].emne == "ferie") return 1;
    		return -1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-lai");
    			add_location(img, file$2, 17, 8, 323);
    			attr_dev(div0, "class", "image-container svelte-lai");
    			add_location(div0, file$2, 16, 4, 284);
    			attr_dev(h1, "id", "title");
    			attr_dev(h1, "class", "svelte-lai");
    			add_location(h1, file$2, 25, 8, 623);
    			attr_dev(p, "id", "undertitle");
    			attr_dev(p, "class", "svelte-lai");
    			add_location(p, file$2, 26, 8, 668);
    			attr_dev(div1, "class", "info-container svelte-lai");
    			add_location(div1, file$2, 19, 4, 378);
    			attr_dev(div2, "class", "container svelte-lai");
    			add_location(div2, file$2, 15, 0, 236);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Article extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { article: 0 });
    ...
    const file$1 = "src\\components\\ArticleList.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:4) {#each articles as article}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 11, 0, 1324);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	let articles = [
    		{
    			...
    			title: "Biden - Styrk cyberforsvaret i Ukraina.",
    			emne: "sikkerhet",
    			image_src: "https://www.kode24.no/images/75665214.jpg?imageId=75665214&panox=0&panoy=8.0213903743316&panow=100&panoh=52.406417112299&heighty=0&heightx=20.068027210884&heightw=41.156462585034&heighth=100&width=245&height=218&compression=80",
    			content: "Biden - Styrk cyberforsvaret i Ukraina.I løpet av et tiår har sosiale medier forandret måten vi kommuniserer med hverandre på. Vi går i retning av et mer teknologibasert samfunn, og Norge blir ofte omtalt som ett av de mest digitale samfunnene i verden. Ungdom bruker opp mot sju timer i gjennomsnitt på nettet daglig. Ungdom bruker mindre tid sammen med venner ansikt til ansikt, og mer tid på Internett og sosiale medier. Varig lagring: Kommunikasjonen i s"
    		},
    		{
    			id: 1,
    			title: "Ove (32) liker seg i hengekøya: - Blir ofte lange lunsjer",
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-hn08ua");
    			add_location(img, file, 9, 3, 153);
    			attr_dev(h1, "class", "svelte-hn08ua");
    			add_location(h1, file, 10, 3, 186);
    			attr_dev(div0, "class", "logo-container svelte-hn08ua");
    			add_location(div0, file, 8, 2, 120);
    			attr_dev(div1, "class", "mid-part svelte-hn08ua");
    			add_location(div1, file, 12, 2, 215);
    			attr_dev(div2, "class", "right-controls svelte-hn08ua");
    			add_location(div2, file, 13, 2, 247);
    			attr_dev(div3, "class", "menu svelte-hn08ua");
    			add_location(div3, file, 7, 1, 98);
    			add_location(body, file, 6, 0, 89);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ router: page, Article: Article$1, Home, page: page$1 });
